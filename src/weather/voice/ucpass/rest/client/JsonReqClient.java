 ...
 * @project rest_demo
 */
package weather.voice.ucpass.rest.client;
...
import weather.voice.models.AppBill;
import weather.voice.models.Callback;
import weather.voice.models.ClientBill;
import weather.voice.models.TemplateSMS;
import weather.voice.models.VoiceCode;
import weather.voice.models.VoiceNotify;
import weather.voice.ucpass.rest.DateUtil;
import weather.voice.ucpass.rest.EncryptUtil;
public class JsonReqClient extends AbsRestClient {
	...
	@Override
	public String voiceMessage(String accountSid, String authToken,String appId,String to,String type,String templateId,String content,String playTimes){
		String result = "";
		DefaultHttpClient httpClient = getDefaultHttpClient();
		try {
			//MD5加密
			...
			String timestamp = DateUtil.dateToStr(new Date(),
					DateUtil.DATE_TIME_NO_SLASH);// 时间戳
			String signature =getSignature(accountSid,authToken,timestamp,encryptUtil);
			String url = getStringBufferForVoice().append("/").append(version)
					.append("/Accounts/").append(accountSid)
