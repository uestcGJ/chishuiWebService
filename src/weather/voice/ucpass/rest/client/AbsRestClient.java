...
import weather.voice.ucpass.rest.SSLHttpClient;
import weather.voice.ucpass.rest.SysConfig;
...
public abstract class AbsRestClient {
	...
	public String server_message=SysConfig.getInstance().getProperty("rest_server_message");
	 ...
	 * voiceMessage(语音电话通知)
	 */
	public abstract String voiceMessage(String accountSid, String authToken,String appId,String to,String type,String templateId,String content,String playTimes);
	/**
	 * 
	 * @param accountSid
	 * @param authToken
	...
	public StringBuffer getStringBufferForVoice(){
		StringBuffer sb = new StringBuffer("https://");
